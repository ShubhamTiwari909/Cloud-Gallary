...
function Contacts() {
  return (
    <section className="grid min-h-screen place-items-center">
      <div className="w-80 md:w-[450px] overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        <Image
          src="https://lh3.googleusercontent.com/a/ACg8ocLi6U_WDkjVStlAmKJ99Ta-VMQJMZf9RdOt8rwGBK5YgRLm-itR=s576-c-no"
          alt="akshit profile"
          width="384"
          height="224"
        ...
        <div className="px-6 py-4">
          ...
          <Para className="py-2 text-gray-700 dark:text-gray-400">
            Full Stack maker & UI / UX Designer , love hip hop music Author of
            Building UI.
          </Para>

          <section className="social-buttons my-6">
            <a
