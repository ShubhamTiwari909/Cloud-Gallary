    ...
    return (
        <div className="w-full fixed top-18 md:top-20 flex flex-col z-100 py-3 bg-gradient-to-r from-black via-gray-900 to-slate-800 -ml-6">
            <div className="flex justify-around">
                ...
                }}><AiOutlineFolderAdd className="text-2xl md:text-4xl" color="rgb(255,255,255,0.8)" /></Button>
                <Button onClick={() => {
                    toggle === "" || toggle === "ADD" ? setToggle("SEARCH") : setToggle("")
                }}><CgSearchLoading className="text-2xl md:text-4xl" color="rgb(255,255,255,0.8)" /></Button>
            </div>
