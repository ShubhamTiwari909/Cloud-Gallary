...
function GallaryForm({ folderName }) {
    ...
    return (
        <>
            ...
            <div className="w-full fixed top-18 md:top-19 flex gap-4 justify-end md:justify-center flex-wrap z-102 py-2 px-2 bg-slate-200 -ml-4">
                <Link href="/folders/navigation"
                    className='fixed left-1.5 top-20 z-102 text-slate-100 flex gap-2 items-center px-4 py-2 rounded-full bg-slate-600 text-sm'>
